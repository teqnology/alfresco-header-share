...
- `alfresco-header-share.amp` found [here](/tree/master/target) (Click on amp file, then on `raw` button to download it).
...
- Stop Alfresco
- Copy the [alfresco-header-share.amp](https://github.com/teqnology/alfresco-header-share) inside your alfresco `amps_share` folder
